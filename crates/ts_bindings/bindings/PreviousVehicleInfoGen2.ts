 ...
 */
export type PreviousVehicleInfoGen2 = { vehicleRegistrationIdentification: VehicleRegistrationIdentification, cardWithdrawalTime: TimeReal | null, vuGeneration: GenerationGen2, };
