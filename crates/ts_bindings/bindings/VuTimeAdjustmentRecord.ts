 ...
 */
export type VuTimeAdjustmentRecord = { oldTimeValue: string, newTimeValue: string, workshopName: Name, workshopAddress: Address, workshopCardNumber: FullCardNumber, };
