 ...
 */
export type CardVehicleRecordGen2 = { vehicleOdometerBegin: OdometerShort, vehicleOdometerEnd: OdometerShort, vehicleFirstUse: TimeReal, vehicleLastUse: TimeReal, vehicleRegistration: VehicleRegistrationIdentification, vuDataBlockCounter: VuDataBlockCounter, vehicleIdentificationNumber: VehicleIdentificationNumber, };
