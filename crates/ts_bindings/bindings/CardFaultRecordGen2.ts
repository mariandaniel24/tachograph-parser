 ...
 */
export type CardFaultRecordGen2 = { faultType: EventFaultTypeGen2, faultBeginTime: TimeReal, faultEndTime: TimeReal, faultVehicleRegistration: VehicleRegistrationIdentification, };
